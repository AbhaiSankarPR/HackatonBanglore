...
<div className="min-h-screen hero-bg">
      ...
      <nav className="flex items-center justify-between px-8 py-6 relative z-10">
        {/* Logo */}
        <div className="text-3xl font-black text-black">RUMI</div>
    ...
    WALLET          </a>
          <Button className="bg-pink-500 hover:bg-pink-600 text-white px-6 py-2 rounded-full font-medium">JOIN</Button>
        </div>
      </nav>
